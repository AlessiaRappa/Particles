...
function App() {
  ...
  function changeParticlesOpacity(e) {
    ...
    return setParticlesOptions({
      ...
      particles: {
        ...particles.particles,
        opacity: { ...particles.particles.opacity, value: e.target.value * 2 },
      },
    });
  }


  function changeParticlesAttract(e) {
    ...
    return setParticlesOptions({
      ...
      particles: {
        ...particles.particles,
        move: { ...particles.particles.move, 
        attract: { ...particles.particles.move.attract, enable: !inputAttract },
      },},
    });
  }
  ...
  return (
    <div className="App">
      <div className="legend">
        ...
        <label htmlFor="attract" id="attract" name="gravity">
          Attract
        </label>
        <input
          id="attract"
          type="checkbox"
          value={inputAttract}
          onChange={changeParticlesAttract}
        />
